...
- [ ] **1. A1** signup 카운트 동기화 — `src/app/signup/page.tsx` 의 "33개/13개/24개/7종" → 실 카운트 (forwarders 30개, marketplaces 14개, supplier_sites 25개, currencies 8개). 또는 "30+개/13+개/24+개" 같은 안전 표기. 추후 forwarders 36 모두 활성 시 자동 반영되도록 server fetch 로 동적화 권장.
