...
- [x] **#idea-3b 환불 관리 Phase 2 — /refunds 페이지 + /orders 연결** _(brainstorm approved 2026-05-27, 2026-05-28 split)_
  ...
  - 후속 (소형): ~~대시보드 미니카드 (이달 환불 건수·금액)~~ (2026-05-29 commit 47542a4 완료 — RefundMiniCard: 신청/처리대기/정산완료 + 정산 환불액 KRW), 페이지네이션 cursor (50건 초과 안내만 노출)
...
- [x] **#idea-11-fu 주문 상세 통관 분류 표시 + 가이드 패널** _(#idea-11 후속, 2026-05-29)_
  ...
  - 후속 (잔여): bulk 그리드 자동 인식 결과 placeholder 노출, 'other' 매칭 포함 검토.
