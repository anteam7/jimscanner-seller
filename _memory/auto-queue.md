...
- [ ] **#auto-I a11y: 운송장 붙여넣기 textarea + SKU 불러오기 검색 input aria-label** _(audit 발견 2026-05-30)_
  - estimated: 10m
  - prereq: 없음
  - decision_required: false
  ...
  - severity: low
  - fix: 두 컨트롤에 `aria-label` 추가 (순수 additive, 동작·시각 무변경). 18~22회차 a11y 일관성 보강과 동일 패턴.
...
- P1 자율 가능: **30개 완료 + 1개 pending** (#7~12, #auto-A~H, #auto-A-followup, #idea-3a/3b/4/5/8/9/10/11, #idea-11-fu 모두 [x]; **#auto-I (2026-05-30 self-audit a11y)** pending — 다음 cron 회차 처리 대기).
