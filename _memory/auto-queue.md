...
- [ ] **#idea-15 부가세 자료 분기/연간 프리셋 + CSV 합계 요약행** _(brainstorm approved 2026-05-30)_
  - estimated: 40-60m
...
- P1 자율 가능: **32개 완료, pending 3** (#7~12, #auto-A~I, #auto-A-followup, #idea-3a/3b/4/5/8/9/10/11/12, #idea-11-fu 완료; **#idea-12** 2026-05-30 30회차 commit 34eb623 완료. **pending: #idea-13 정산 대조 / #idea-14 보관기간 알림 / #idea-15 부가세 프리셋·합계행** — 2026-05-30 user approve 로 큐 추가).
