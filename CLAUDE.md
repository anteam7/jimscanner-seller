...
짐스캐너 B2B SaaS — 구매대행·해외직구 사업자용 도구.

**핵심 가치 (MVP):** 사업자가 의뢰자 주문을 받아 33개 한국 배대지의 각자 다른 신청 양식으로 자동 변환 + 엑셀 다운로드.

- 도메인: `seller.jimscanner.co.kr` (별도 Vercel project)
- 1차 타깃: 월 100~500건 처리하는 구매대행 사업자
- 차별점: 33 배대지 양식 통합 자동 변환 (샵링커형, 직구 특화)
