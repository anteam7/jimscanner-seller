...
/**
 * (app) 인증 영역 에러 바운더리 — 페이지 서버 컴포넌트의 데이터 fetch 실패 등
 * 렌더 중 throw 를 잡아 SellerShell 안에서 복구 가능한 안내를 보여준다.
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      ...
      >
        ...
        <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-slate-600">
          페이지를 불러오는 중 일시적인 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.
          문제가 계속되면 1:1 문의로 알려 주시면 빠르게 도와드리겠습니다.
        </p>
