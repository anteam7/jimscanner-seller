...
/**
 * 회원가입 플로우 에러 바운더리 — step-1~6 클라이언트 컴포넌트의 렌더 throw
 * (약관·계정·사업자 조회 실패 등) 를 잡아 루트 레이아웃을 갈아치우지 않고
 * 가입 맥락에 맞는 복구 안내를 보여준다. global-error 폴백은 루트 전체를 대체하고
 * "대시보드로" 만 안내해 미인증 가입자에겐 부적합하므로, 이 세그먼트 전용 그물을 둔다.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 text-slate-900">
      ...
      >
        ...
        <h1 className="text-lg font-bold tracking-tight text-slate-900">가입 중 문제가 발생했습니다</h1>
        <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-slate-600">
          가입 단계를 불러오는 중 일시적인 오류가 발생했습니다. 입력하신 내용은 안전하게 저장되어 있으니
          잠시 후 다시 시도해 주세요. 문제가 계속되면 로그인 후 이어서 진행할 수 있습니다.
        </p>
