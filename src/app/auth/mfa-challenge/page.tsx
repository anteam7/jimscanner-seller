    ...
    <AuthShell topRight={null}>
      <div className="rounded-2xl border border-slate-200 bg-white shadow-xl p-8 space-y-6">
        <div className="text-center space-y-1">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">2단계 인증</h1>
          <p className="text-slate-600 text-sm">
        ...
        {cooldownUntil && (
          <div role="alert" className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-amber-50 border border-amber-200 text-amber-800 text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div aria-live="polite" className="space-y-2">
              ...
              />
              {error && (
                <p id="mfa-error" role="alert" className="text-sm text-rose-600 text-center">
                  {error}
                </p>
              )}
            </div>
